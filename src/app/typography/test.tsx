...
export function Heading({
  ...
  switch (level) {
    ...
    case 2:
      return (
        <h2 className={headingClassName} {...rest}>
          {children}
        </h2>
      );
    case 3:
      return (
        <h3 className={headingClassName} {...rest}>
          {children}
        </h3>
      );
    case 4:
      return (
        <h4 className={headingClassName} {...rest}>
          {children}
        </h4>
      );
    case 5:
      return (
        <h5 className={headingClassName} {...rest}>
          {children}
        </h5>
      );
    case 6:
      return (
        <h6 className={headingClassName} {...rest}>
          {children}
        </h6>
      );
    default:
...
interface IndividualHeadingProps
