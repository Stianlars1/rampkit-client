// Produces a React module with typed, polymorphic primitives for your
// typography system.  Consumers import this file along with the
// generated `typography.module.scss` to get `Text`, `Heading`, `Link`
// and `ListItem` components.
