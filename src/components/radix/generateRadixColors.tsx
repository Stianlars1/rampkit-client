...
export const generateRadixColors = ({
  ...
  // Limit saturation of the text color
...
function getScaleFromColor(
  ...
  // If the next two closest color are both grays, remove the second one until it’s not a gray anymore.
  // This is because up next we will be comparing how close the two closest color are to the source color,
  ...
  // to proportionally mix the two closest color together, but sometimes it is not useful at all.
  ...
  // closest color in the same proportion as distances AD and BD are to each other. Mixing the two would result
  // in a color that would be closer to the source color than either of the two original closest color.
